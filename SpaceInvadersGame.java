...
/**
 ...
 1. На будущее:
  ...
  - поменять систему начисления очков:
 например, чем быстрее уничтожен корабль, тем больше очков за него дается;
  - добавить укрытия для игрока;
  - при попадании в определенный корабль получать бонусы:
 например, временное бессмертие, супероружие и т.д.;
